...
export default function NoteList({ subject, onBack }) {
  return (
    <div style={{ padding: '16px' }}>
      <button onClick={onBack} style={{ marginBottom: '16px', color: '#007bff', background: 'none', border: 'none', cursor: 'pointer' }}>
        &larr; 返回
      </button>

      <h2
        style={{fontSize: '20px',fontWeight: 'bold',marginBottom: '12px',textAlign: 'left',}}>
        {subject} 筆記
      </h2>
