...
export default function NotebookDashboard() {
  ...
  const loadNotes = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/notes", authHeader);
  ...
  const addNote = async () => {
    ...
    try {
      const res = await axios.post("http://localhost:5000/api/notes", newNote, authHeader);
  ...
  const deleteNote = async (id) => {
    ...
    try {
      await axios.delete(`http://localhost:5000/api/notes/${id}`, authHeader);
